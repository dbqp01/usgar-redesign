...
- [ ] **P3-6** Suite `run-exhaustive-tests.php`: ya no cuelga (fix P3-2); sigue golpeando servicios reales si los tests de integración se extienden — si se añaden tests que toquen MP/QloApps, mockear los adapters (los unit ya son hermeticos: phpunit 194 tests/648 assertions sin red).
