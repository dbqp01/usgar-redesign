 ...
 * SEGURIDAD: Solo ejecutable en CLI o en ENVIRONMENT=development.
 *
...
try {
    ...
    if ($pdo) {
        ...
        // Limpiar holds de prueba previos (prepared statement, no SQL injection)
        ...
        if ($holdCreated) {
            ...
            // Limpieza con prepared statement (Fix SQL Injection)
